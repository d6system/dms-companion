module.exports = {
    ...
    inputs: [
        ...
        },
        {
            "id": "value4",
            "name": "Value 4",
            "description": "Acceptable Types: Unspecified, Undefined, Null, Object, Boolean, Date, Number, Text, List\n\nDescription: The value 4 to send to the receiver(s). (OPTIONAL)",
            "types": ["unspecified", "undefined", "null", "object", "boolean", "date", "number", "text", "list"]
        },
        {
            "id": "value5",
            "name": "Value 5",
            "description": "Acceptable Types: Unspecified, Undefined, Null, Object, Boolean, Date, Number, Text, List\n\nDescription: The value 5 to send to the receiver(s). (OPTIONAL)",
            "types": ["unspecified", "undefined", "null", "object", "boolean", "date", "number", "text", "list"]
        },
        {
            "id": "value6",
            "name": "Value 6",
            "description": "Acceptable Types: Unspecified, Undefined, Null, Object, Boolean, Date, Number, Text, List\n\nDescription: The value 6 to send to the receiver(s). (OPTIONAL)",
            "types": ["unspecified", "undefined", "null", "object", "boolean", "date", "number", "text", "list"]
        },
        {
            "id": "value7",
            "name": "Value 7",
            "description": "Acceptable Types: Unspecified, Undefined, Null, Object, Boolean, Date, Number, Text, List\n\nDescription: The value 7 to send to the receiver(s). (OPTIONAL)",
            "types": ["unspecified", "undefined", "null", "object", "boolean", "date", "number", "text", "list"]
        },
        {
            "id": "value8",
            "name": "Value 8",
            "description": "Acceptable Types: Unspecified, Undefined, Null, Object, Boolean, Date, Number, Text, List\n\nDescription: The value 8 to send to the receiver(s). (OPTIONAL)",
            "types": ["unspecified", "undefined", "null", "object", "boolean", "date", "number", "text", "list"]
        }
    ],
    ...
    code(cache) {
        ...
        const value7 = this.GetInputValue("value7", cache);
        const value8 = this.GetInputValue("value8", cache);
        const restriction_type = this.GetOptionValue("restriction_type", cache) + "";
        const search_type = this.GetOptionValue("search_type", cache) + "";

        this.Emitter(id, {restriction_type, search_type, search_value, values: [value1, value2, value3, value4, value5, value6, value7, value8]}, cache);
