module.exports = {
    name: 'Server Emoji Delete [Event]',

    description:
        'When an emoji is deleted in a server, this event will trigger.',
    ...
    outputs: [
        ...
        },
        {
            ...
            name: 'Server Emoji',
            description:
                'Type: Object\n\nDescription: The deleted server emoji.',
            types: ['object']
        },
        {
            id: 'user',
            name: 'User (UNSTABLE)',
            description:
                'Type: Object, Undefined\n\nDescription: The user who deleted the server emoji. (This can be UNSTABLE and INACCURATE and can return an undefined value)',
        ...
        },
        {
            ...
            description:
                'Type: Text\n\nDescription: The reason for deleting the server emoji if any. (This can be UNSTABLE and INACCURATE)',
            types: ['text']
        }
    ],
    ...
    code(cache) {
        ...
        this.events.on('emojiDelete', async (server_emoji) => {
            ...
            if (unstable_outputs == 'yes' && server_emoji.guild) {
                ...
                if (
                    ...
                    const entry = await server
                        .fetchAuditLogs({ type: AuditLogEvent.EmojiDelete, limit: 5 })
                        .then((audit) =>
                            audit.entries.find(
                                (a) =>
